...
| **vkapp-only**                      | Проект со следующими библиотеками и инструментами:<ul><li>VKUI</li><li>@vkontakte/icons</li><li>React и React-DOM</li><li>Vite</li><li>ESlist</li></ul>Этот вариант не подойдёт для создания мини-приложений, так как в нём отсутствует VK Bridge — библиотека, которая необходима для взаимодействия с платформой. Используйте этот вариант для создания веб-приложений, использующих библиотеку VKUI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
